...
- Рефакторинг.
    - Вместо нод с правилами проверки форматов беру непосредственно словарь аттрибутов этой ноды.
...
- Изменил формат ответа.
    - Теперь это не список строк, а список словарей вида {'code': '1.1', 'name': 'Проверка аттрибутов', 'message': 'Указан недопустимый год'}
